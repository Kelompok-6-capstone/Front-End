...
export default function BreadcrumbDaftarSemuaArtikel() {
    return (
        <>
            <ol className="flex items-center whitespace-nowrap mt-28 px-3 lg:px-0">
                <li className="inline-flex items-center">
                    ...
                    <img
                        className="ml-2 transform transition-transform duration-300 group-hover:rotate-90"
