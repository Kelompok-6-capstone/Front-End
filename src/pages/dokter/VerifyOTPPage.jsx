...
import { verifyDoctorOtp } from "../../api/doctor/doctor";
import { resendDoctorOtp } from "../../api/doctor/doctor";
import { useNavigate } from "react-router-dom";

const VerifyOtpDoctorPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setErrorMessage('');
        try {
          await verifyDoctorOtp({ email: formData.email, code: formData.code }); // Tidak perlu menyimpan response jika tidak digunakan
          Swal.fire({
            icon: 'success',
            title: 'Berhasil!',
            text: 'Verifikasi berhasil! Anda dapat login sekarang.',
...
export default VerifyOtpDoctorPage;
